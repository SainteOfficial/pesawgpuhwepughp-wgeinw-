...
if not isKeyValid then
    ...
    KeySystemUI.Name = "MythHubKeySystem"
    ...
    SubmitButton.Position = UDim2.new(0.5, -60, 0.7, -20)
    ...
    GetKeyButton.Position = UDim2.new(0.5, -60, 0.85, -20)
    ...
    StatusLabel.Position = UDim2.new(0, 0, 0.55, -10)
    ...
    SubmitButton.MouseButton1Click:Connect(function()
        ...
        if MythKeySystem.validateKey(userKey) then
            StatusLabel.Text = "Key valid! Loading..."
            StatusLabel.TextColor3 = Color3.fromRGB(150, 255, 150)
            
            -- Key speichern für zukünftige Nutzung (optional)
            local WindowUtil = require(game.ReplicatedStorage:WaitForChild("SharedModules"):WaitForChild("WindowUtil"))
            WindowUtil:SetSetting("MythHubKey", userKey)
            
            -- UI entfernen nach kurzer Verzögerung
            wait(1)
            KeySystemUI:Destroy()
            
            -- MythHub laden (erneuter Aufruf des Scripts)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/Username/MythHub/main/MythHub.lua"))()
            return
        else
    ...
    -- Hier wird Script beendet, wenn Key nicht valid ist
    return
end
